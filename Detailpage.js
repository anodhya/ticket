...
function validateForm() {
  ...
  var fullName = document.getElementById("D-name").value;
  var phoneNumber = document.getElementById("D-mobile").value;
  ...
  if (!/^[A-Za-z\s]+$/.test(fullName.trim())) {
    alert("Please enter only alphabetic characters in your full name.");
    return false;
}
...
function populateSummaryTable() {
  ...
  if (userInputs) {
    document.getElementById("D-date").textContent = userInputs.date;
    document.getElementById("D-time").textContent=userInputs.time;
    document.getElementById("D-period").textContent=userInputs.period;
    document.getElementById("D-SLA").textContent=userInputs.sla;
    document.getElementById("D-SLC").textContent=userInputs.slc;
    document.getElementById("D-FA").textContent=userInputs.fa;
    document.getElementById("D-FC").textContent=userInputs.fc;
    document.getElementById("D-I").textContent=userInputs.i;
    document.getElementById("D-tot").textContent=userInputs.total;
    document.getElementById("D-charges1").textContent=userInputs.charges1;
    document.getElementById("D-charges2").textContent=userInputs.charges2;
    document.getElementById("D-charges3").textContent=userInputs.charges3;
    document.getElementById("D-charges4").textContent=userInputs.charges4;
    document.getElementById("D-charges5").textContent=userInputs.charges5;
  }
}
...
const continueButton2 = document.querySelector("#Detailpagebtn button");
continueButton2.addEventListener("click", saveUserInput);
